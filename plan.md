...
- Tenant-local timezone persistence and column-level health checks for critical settings/product warranty fields, preventing an incomplete customer schema from being reported as healthy.
